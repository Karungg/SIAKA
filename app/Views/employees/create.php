    ...
    <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?= site_url('employee/create') ?>" method="post">
              <div class="form-group">
                <label for="fullname">Full Name</label>
                <input type="text" class="form-control <?= (isset($validation)) ? 'is-invalid' : '' ?>" name="fullname" id="fullname" value="">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control <?= (isset($validation)) ? 'is-invalid' : '' ?>" name="email" id="email" value="">
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= (isset($validation)) ? 'is-invalid' : '' ?>" name="username" id="username" value="">
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control <?= (isset($validation)) ? 'is-invalid' : '' ?>" name="phone" id="phone" value="">
                <div class="invalid-feedback">

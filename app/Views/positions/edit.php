...
<section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Edit Positions</div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                      <form action="<?= site_url('position/edit/' . $position['id']) ?>" method="post">
                      <div class="form-group">
                        <label for="position">Name Position</label>
                        <input type="text" class="form-control <?= (isset($validation)) ? 'is-invalid' : '' ?>" name="position" id="position" value="<?= $position['name'] ?>">
